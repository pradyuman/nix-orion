...
The [settings catalog](settings.nix) also includes the accepted raw values for
settings with a fixed set of choices, including nested values such as toolbar
item identifiers.
